...
/* f(n) = count of numbers with unique digits which are less than 10^n.
f(1) = [0, 1,2,...,9] = 10
f(2) = 9 * 9. Because for each number i from 1, ..., 9, we can pick j to form a 2-digit number ij and there are 9 numbers 
